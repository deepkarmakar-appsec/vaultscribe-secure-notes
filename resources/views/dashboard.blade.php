...
<aside class="sidebar">
    <div class="sidebar-logo">
        ...
        <span class="logo-name">VaultScribe</span>
    </div>
    ...
    <div class="content">
        ...
        <section class="form-card" style="animation-delay: 0.2s;">
            ...
            <form id="noteForm" method="POST" action="{{ route('notes.store') }}">
                @csrf
                <input name="title" type="text" placeholder="Write the title..." class="form-input">
                <textarea name="description" placeholder="Write something meaningful..." class="form-input form-textarea"></textarea>

                <div class="card-footer">
                    <span style="font-size: 11px; color: var(--gray-400); font-weight: 500;">[Ctrl + S to save]</span>
                    <div style="display: flex; gap: 10px;">
                        <button type="button" class="mbtn mbtn-sec" onclick="openModal('modal-url')">
                            <i class="fa-solid fa-link"></i> Import URL
                        </button>
                        <button type="button" id="aiGenerateBtn" class="mbtn mbtn-sec">
                            ✦ AI Summary
                        </button>
                        <button type="submit" class="mbtn mbtn-pri">Save Note</button>
                    </div>
                </div>
            </form>
        </section>
